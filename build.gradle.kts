// Top-level build file for root project
// This file configures plugins that should be applied to all subprojects
...
tasks.register("clean", Delete::class) {
    ...
    delete(file("android-app/build"))
    delete(file("android-app/app/build"))
}
